...
#       #######################################################################
#        # CODE GOES HERE
#        hsv_thresh/=255 # divides hold image by 225
#        twist_msg = Twist()
#        print "====="
...
#       
#        
#        leftim = numpy.sum(hsv_thresh[:, 0:320]) # can be replaced with .sum or mean
#        rightim = numpy.sum(hsv_thresh[:, 320:640])
#        leftim1 = numpy.mean(hsv_thresh[:, 0:320])
#        rightim1 = numpy.mean(hsv_thresh[:, 320:640])
#        wholeintensity = numpy.sum(hsv_thresh)           # Getting the mean intensity of the whole image
#        wholeintensity1 = numpy.mean(hsv_thresh) 
#        wholeintensity2 = numpy.mean(hsv_thresh1)
#        wholeintensityn = wholeintensity2 /255
#        #normalised_mean_intensity = mean_intensity / 255
##        if wholeintensity   < 120:
##            print "Mean intensity left: ", leftim
##            print "Mean intensity right: ", rightim
##            print "Normalised mean intensity: ", wholeintensity
##            time.sleep(2)
#        print "Normalised mean intensity: ", wholeintensity
#        print "Normalised mean intensity1: ", wholeintensity1        
#        print "Normalised mean intensityn: ", wholeintensityn
#
#        print "Mean intensity left: ", leftim
#        print "Mean intensity right: ", rightim
#        print "Mean intensity left: ", leftim1
#        print "Mean intensity right: ", rightim1
#        time.sleep(1)
#        #time.sleep(2) 
