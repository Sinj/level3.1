...
#        print numpy.mean(hsv_img[:, :, 2])            
       ...
       #######################################################################
        ...
        twist_msg = Twist()
        print "====="
        mean_leftim = numpy.mean(hsv_img[0:320, 0:240])
        mean_rightim = numpy.mean(hsv_img[320:640, 240:480])
        mean_intensity = numpy.mean(hsv_img)           # Getting the mean intensity of the whole image
...
#        twist_msg.angular.z = (left_normalised_mean_intensity - right_normalised_mean_intensity)* numpy.pi/4
        ...
        cv2.imshow("Image window", hsv_img)  # Showing the image
