...
#            print "Mean intensity right: ", rightim
    ...
    def laser_callback(self, msg):
        ...
        while (self.timer + 30) > time.time() and self.isrun == True and not rospy.is_shutdown():
            if min_distance < 0.85 and self.isrun == True:                    # If the robot is close, then
            ...
            elif min_distance >= 0.85 and self.isrun == True:                                    # If the robot is far away from everything, then
                #rospy.loginfo("Straight")
                twist_msg.linear.x = 2.0                 # Set linear movement
