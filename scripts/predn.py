...
#        print numpy.mean(hsv_img[:, :, 2])
        ...
        #check if seen
            if wholeintensity1 > 150:#200:#100:#600:
                self.robotseen =True
            else:
                self.robotseen = False
          

        if self.robotseen and self.min_distance <=1.3:
...
#                 twist_msg.angular.z = 0
#             elif leftim > rightim:
#                 twist_msg.angular.z = numpy.pi/6
#             else:
#                 twist_msg.angular.z = (numpy.pi/6)*1
             
                
        elif self.robotseen and self.min_distance > 1.3 :
            #print 'out'
            self.robotseen =True
            if not self.iswall:
                print 'out'
...
#        print '---'
        ...
        if (leftside - rightside) >=-0.20 and (leftside - rightside) <=0.20:
